...
MiioDevice.prototype.homekit_execute_method = function (method, params, callback) {
    // console.log("homekit_execute_method: " + this.mac + " " + this.sDid + " " + method + " " + params);
...
MiioDevice.prototype.homekit_execute_get = function (method, params, callback) {
    // console.log("homekit_execute_get: " + this.mac + " " + this.sDid + " " + method + " " + params);
    var rpcid = this.nextId();
    this.rpc(JSON.stringify({
        "id": rpcid,
        "method": method,
