...
module.exports = function (device) {
    var a = new ZhimiAirpurifierV3(device);
    return a.getAccessory();
};

function ZhimiAirpurifierV3(device) {
    this.device = device;
...
ZhimiAirpurifierV3.prototype.getAccessory = function () {
    return this.accessory;
}

ZhimiAirpurifierV3.prototype.initializeServices = function () {
    /**
     * Fan
     */
...
ZhimiAirpurifierV3.prototype.SetOn = function(value, callback) {
...
ZhimiAirpurifierV3.prototype.GetOn = function(callback) {
...
ZhimiAirpurifierV3.prototype.SetRotationSpeed = function(value, callback) {
    var method_name = "set_mode";
    var method_args;
...
ZhimiAirpurifierV3.prototype.GetRotationSpeed = function(callback) {
    var method_name = "get_prop";
...
ZhimiAirpurifierV3.prototype.GetAirQuality = function(callback) {
    var method_name = "get_prop";
    var method_args = ['aqi'];
