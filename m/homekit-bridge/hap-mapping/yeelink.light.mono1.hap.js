...
module.exports = function (device) {
    var a = new YeelinkLightMono1(device);
    return a.getAccessory();
};

function YeelinkLightMono1(device) {
    this.device = device;
...
YeelinkLightMono1.prototype.getAccessory = function () {
    return this.accessory;
}

YeelinkLightMono1.prototype.initializeServices = function () {
...
YeelinkLightMono1.prototype.SetOn = function(value, callback) {
...
YeelinkLightMono1.prototype.GetOn = function(callback) {
...
YeelinkLightMono1.prototype.SetBrightness = function(value, callback) {
...
YeelinkLightMono1.prototype.GetBrightness = function(callback) {
    var method_name = "get_prop";
