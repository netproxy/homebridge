...
module.exports = function (device) {
    var a = new ZhimiAirpurifierM1(device);
    return a.getAccessory();
};

function ZhimiAirpurifierM1(device) {
    this.device = device;
...
ZhimiAirpurifierM1.prototype.getAccessory = function () {
    return this.accessory;
}

ZhimiAirpurifierM1.prototype.initializeServices = function () {
    /**
     * Fan
     */
...
ZhimiAirpurifierM1.prototype.SetOn = function(value, callback) {
...
ZhimiAirpurifierM1.prototype.GetOn = function(callback) {
...
ZhimiAirpurifierM1.prototype.SetRotationSpeed = function(value, callback) {
    var method_name = "set_mode";
    var method_args;
...
ZhimiAirpurifierM1.prototype.GetRotationSpeed = function(callback) {
    var method_name = "get_prop";
...
ZhimiAirpurifierM1.prototype.GetAirQuality = function(callback) {
    var method_name = "get_prop";
    var method_args = ['aqi'];
...
ZhimiAirpurifierM1.prototype.GetCurrentRelativeHumidity = function(callback) {
    var method_name = "get_prop";
