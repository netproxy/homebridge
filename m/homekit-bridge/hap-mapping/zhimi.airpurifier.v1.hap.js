...
module.exports = function (device) {
    var a = new ZhimiAirpurifierV1(device);
    return a.getAccessory();
};

function ZhimiAirpurifierV1(device) {
    this.device = device;
...
ZhimiAirpurifierV1.prototype.getAccessory = function () {
    return this.accessory;
}

ZhimiAirpurifierV1.prototype.initializeServices = function () {
    /**
     * Fan
     */
...
ZhimiAirpurifierV1.prototype.SetOn = function(value, callback) {
...
ZhimiAirpurifierV1.prototype.GetOn = function(callback) {
...
ZhimiAirpurifierV1.prototype.SetRotationSpeed = function(value, callback) {
    var method_name = "set_mode";
    var method_args;
...
ZhimiAirpurifierV1.prototype.GetRotationSpeed = function(callback) {
    var method_name = "get_prop";
...
ZhimiAirpurifierV1.prototype.GetAirQuality = function(callback) {
    var method_name = "get_prop";
    var method_args = ['aqi'];
