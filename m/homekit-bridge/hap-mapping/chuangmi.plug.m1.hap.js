...
module.exports = function (device) {
    var a = new ChuangmiPlugM1(device);
    return a.getAccessory();
};

function ChuangmiPlugM1(device) {
    this.device = device;
...
ChuangmiPlugM1.prototype.getAccessory = function () {
    return this.accessory;
}

ChuangmiPlugM1.prototype.initializeServices = function () {
...
ChuangmiPlugM1.prototype.SetOn = function(value, callback) {
...
ChuangmiPlugM1.prototype.GetOn = function(callback) {
